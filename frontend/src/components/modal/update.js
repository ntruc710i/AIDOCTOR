...
const UpdateRecordModal = (props) => {
    ...
    const updateRecord = () => {
        ...
        if (!isValid) return
        console.log(record.rspred)
        axios.put(`http://127.0.0.1:8000/updaterecord/${props._id}`, {
            "name": name,
            "gender": gender,
            "idnumber": idnumber,
            "birthday": birthday,
          ...
          {console.log(props._id)}
            ...
            <div class="py-1 backdrop-blur-sm bg-white/30 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
                <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    ...
                    <h1 class="text-gray-800 font-lg font-bold tracking-normal leading-tight text-center mb-2">UPDATE REPORT</h1>
                        ...
                        <h1 class="flex justify-start text-gray-800 font-lg font-bold tracking-normal leading-tight mb-2">Enter Patient Details</h1>
                        <div class="relative mb-5">
                            <label for="name" class="flex justify-start text-gray-800 text-sm font-bold leading-tight tracking-normal">Name</label>
                        ...
                        <label for="idnumber" class="flex justify-start text-gray-800 text-sm font-bold leading-tight tracking-normal">Identification Number</label>
                        ...
                        <label for="expiry" class="flex justify-start text-gray-800 text-sm font-bold leading-tight tracking-normal">Birthday</label>
                        <div class="relative mb-5 mt-2">
                        ...
                        <label for="phone" class="flex justify-start text-gray-800 text-sm font-bold leading-tight tracking-normal">Phone Number</label>
                        ...
                        <input type="hidden" name="im" value={record.image}/>
                        <input type="hidden" name="rsimage" value={record.rsimage}/>
                        <input type="hidden" name="rspred" value={record.label}/>
                        <div class="flex items-center justify-start w-full">
                            <button class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm"  onClick={updateRecord}>Update</button>
